...
import eu.glaasri.inventorymanager.data.InventoryDbHelper;
import eu.glaasri.inventorymanager.data.StockItem;
    ...
    private void addDummyData() {
        StockItem gummibears = new StockItem(
            "Gummibears",
                ...
                "+49 000 000 0000",
                "haribo@sweet.com",
                "android.resource://eu.admin.inventorymanager/drawable/gummibear");
        ...
        StockItem cherries = new StockItem(
                ...
                "+49 000 000 0000",
                "haribo@sweet.com",
                "android.resource://eu.admin.inventorymanager/drawable/cherry");
        ...
        StockItem cola = new StockItem(
                ...
                "+49 000 000 0000",
                "haribo@sweet.com",
                "android.resource://eu.admin.inventorymanager/drawable/cola");
        ...
        StockItem fruitSalad = new StockItem(
                ...
                "+49 000 000 0000",
                "haribo@sweet.com",
                "android.resource://eu.admin.inventorymanager/drawable/fruit_salad");
        ...
        StockItem smurfs = new StockItem(
                ...
                "+49 000 000 0000",
                "haribo@sweet.com",
                "android.resource://eu.admin.inventorymanager/drawable/smurfs");
